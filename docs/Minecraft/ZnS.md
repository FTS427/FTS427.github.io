...
> 具体内容请见[*游戏环境基础原则*](./gamimg_env.md)，如果服务器出现以上内容请尽快发送邮件至 <FTS427@outlook.com> 联系本服 QQ 群群主！

[^1]: 现在仅允许：基岩版、Java 正版、Java 外部登录([LittleSkin](https://littleskin.cn)) 在按照服务器首次注册完成后进入服务器游玩
